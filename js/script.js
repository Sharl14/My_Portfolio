...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (reachForm && formStatus) {
    reachForm.addEventListener("submit", async (e) => {
      ...
      // If deployed to Netlify (data-netlify attribute), submit using URL-encoded body
      const isNetlify = reachForm.hasAttribute("data-netlify");
      ...
      // Fallback: if action points to Formspree, use fetch as before
